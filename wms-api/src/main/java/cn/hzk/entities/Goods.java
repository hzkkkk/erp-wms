...
@TableName("wms_goods")
@ApiModel(value="Article对象", description="物资信息表")
public class Goods implements Serializable {
    ...
    @ApiModelProperty(value = "物资标题")
    private String title;

    @ApiModelProperty(value = "物资简介")
    private String summary;

    @ApiModelProperty(value = "物资主图地址")
    ...
    @ApiModelProperty(value = "所属供应商对象集合")
    @TableField(exist = false)
    private List<Label> labelList;

    @ApiModelProperty(value = "所属供应商ID集合")
    @TableField(exist = false)
