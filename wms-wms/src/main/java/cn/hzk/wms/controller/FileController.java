...
import cn.hzk.util.aliyun.AliyunUtil;
import cn.hzk.util.base.Result;
import cn.hzk.util.enums.PlatformEnum;
import cn.hzk.util.properties.AliyunProperties;
import cn.hzk.util.properties.BlogProperties;
...
public class FileController {
    ...
    @PostMapping("/upload") // /wms/file/upload
    ...
    @DeleteMapping("/delete") // /wms/file/delete
